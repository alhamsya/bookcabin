...
//
//	mockgen -package=mockservice -source=flight.go -destination=../.././../mock/service/flight.go
//
...
import (
	...
	modelResponse "github.com/alhamsya/bookcabin/internal/core/domain/response"
...
func (m *MockFlightService) Search(ctx context.Context, param *modelFlight.ReqSearch) (modelResponse.Common, error) {
	m.ctrl.T.Helper()
